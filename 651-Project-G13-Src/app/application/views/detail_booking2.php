<div class="container mt-3">
  ...
  <div class="d-flex justify-content-end">
    <?php 
        echo anchor('index.php/C_pick_up_car/index/', 'back', 'class="btn btn-info"');
        ?> 
   </div>    
  <hr>
        <div >
            <?php foreach ( $bookings->result() as $booking ) { ?>
                ...
                <p>name : <?php echo $booking->user_name ?> </p>
                <p>email : <?php echo $booking->user_email ?> </p><hr>
        ...
        <br>
        <?php 
        echo anchor('index.php/C_pick_up_car/form_add_data_pickupcar/'.$booking->id_booking, 'บันทึกการมารับรถ', 'class="btn btn-success"');
        $this->session->set_flashdata('id_car',$booking->id_car);
        ?> 
          <hr>
